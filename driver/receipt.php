...
<body>
    ...
    <div class="receipt">
        <div class="items">
            ...
            $sql = "SELECT route_id, time_date, starting_lat, starting_lng, new_lat, new_lng, plate_number, user_id FROM history_1 WHERE status = 'active' ORDER BY time_date DESC LIMIT 1";
