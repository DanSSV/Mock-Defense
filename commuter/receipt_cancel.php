...
<body>
    ...
    <div class="receipt">
        <div class="items">
            ...
            $sql = "SELECT route_id, time_date, starting_lat, starting_lng, currentMarker_lat, currentMarker_long, plate_number FROM history_1 WHERE user_id = '$user_id' AND status = 'Cancelled' ORDER BY time_date DESC LIMIT 1";
